.class final Lj$/util/stream/IntPipeline$3;
...
.method public synthetic constructor <init>(Lj$/util/stream/AbstractPipeline;IILjava/lang/Object;I)V
    ...
    iput p5, p0, Lj$/util/stream/IntPipeline$3;->$r8$classId:I

    iput-object p4, p0, Lj$/util/stream/IntPipeline$3;->val$mapper:Ljava/lang/Object;

    invoke-direct {p0, p1, p3}, Lj$/util/stream/IntPipeline$StatelessOp;-><init>(Lj$/util/stream/AbstractPipeline;I)V
...
.method final opWrapSink(ILj$/util/stream/Sink;)Lj$/util/stream/Sink;
    ...
    iget p1, p0, Lj$/util/stream/IntPipeline$3;->$r8$classId:I
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/DistinctOps$1$2;-><init>(Lj$/util/stream/IntPipeline$3;Lj$/util/stream/Sink;)V
