.class final Lj$/util/stream/SliceOps$3;
...
# direct methods
.method constructor <init>(Lj$/util/stream/AbstractPipeline;IIJJ)V
    .locals 0
    ...
    invoke-direct {p0, p1, p3}, Lj$/util/stream/LongPipeline$StatefulOp;-><init>(Lj$/util/stream/AbstractPipeline;I)V
...
.method final opEvaluateParallel(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    invoke-virtual/range {p1 .. p2}, Lj$/util/stream/Node$-CC;->exactOutputSizeIfKnown(Lj$/util/Spliterator;)J
    ...
    invoke-virtual/range {p1 .. p1}, Lj$/util/stream/Node$-CC;->getSourceShape$enumunboxing$()I
    ...
    invoke-static/range {v10 .. v15}, Lj$/util/stream/Node$-CC;->access$200(ILj$/util/Spliterator;JJ)Lj$/util/Spliterator;

    move-result-object v0

    move-object/from16 v2, p1

    invoke-static {v2, v0, v8}, Lj$/util/stream/Nodes;->collectLong(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Z)Lj$/util/stream/Node$OfLong;
    ...
    invoke-virtual/range {p1 .. p1}, Lj$/util/stream/Node$-CC;->getStreamAndOpFlags()I
    ...
    invoke-virtual/range {p1 .. p2}, Lj$/util/stream/Node$-CC;->wrapSpliterator(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-static {v9, v0, v8}, Lj$/util/stream/Nodes;->collectLong(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Z)Lj$/util/stream/Node$OfLong;
    ...
    invoke-direct/range {v0 .. v8}, Lj$/util/stream/SliceOps$SliceTask;-><init>(Lj$/util/stream/AbstractPipeline;Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Lj$/util/function/IntFunction;JJ)V
...
.method final opEvaluateParallelLazy(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-static {v12, v13, v1, v2}, Lj$/util/stream/Node$-CC;->access$000(JJ)J
    ...
    sget-object v4, Lj$/util/stream/FindOps$$ExternalSyntheticLambda7;->INSTANCE$1:Lj$/util/stream/FindOps$$ExternalSyntheticLambda7;
...
.method final unorderedSkipLimitSpliterator(Lj$/util/Spliterator$OfLong;JJJ)Lj$/util/Spliterator$OfLong;
    .locals 8
