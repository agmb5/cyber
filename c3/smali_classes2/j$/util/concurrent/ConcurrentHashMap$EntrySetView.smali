...
.method public final addAll(Ljava/util/Collection;)Z
    ...
    invoke-virtual {v3, v4, v2, v0}, Lj$/util/concurrent/ConcurrentHashMap;->putVal(Ljava/lang/Object;Ljava/lang/Object;Z)Ljava/lang/Object;
...
.method public final iterator()Ljava/util/Iterator;
    ...
    iget-object v1, v0, Lj$/util/concurrent/ConcurrentHashMap;->table:[Lj$/util/concurrent/ConcurrentHashMap$Node;
    ...
    :goto_0
    new-instance v3, Lj$/util/concurrent/ConcurrentHashMap$EntryIterator;

    invoke-direct {v3, v1, v2, v2, v0}, Lj$/util/concurrent/ConcurrentHashMap$EntryIterator;-><init>([Lj$/util/concurrent/ConcurrentHashMap$Node;IILj$/util/concurrent/ConcurrentHashMap;)V
...
.method public final synthetic parallelStream()Ljava/util/stream/Stream;
    ...
    .line 1
    invoke-static {p0}, Lj$/util/Map$-CC;->$default$parallelStream(Ljava/util/Collection;)Lj$/util/stream/Stream;
...
.method public final synthetic removeIf(Lj$/util/function/Predicate;)Z
    ...
    invoke-static {p0, p1}, Lj$/util/Map$-CC;->$default$removeIf(Ljava/util/Collection;Lj$/util/function/Predicate;)Z
...
.method public final synthetic stream()Lj$/util/stream/Stream;
    ...
    invoke-static {p0}, Lj$/util/Map$-CC;->$default$stream(Ljava/util/Collection;)Lj$/util/stream/Stream;
