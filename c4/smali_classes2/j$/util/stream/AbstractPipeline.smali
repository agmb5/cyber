...
.method constructor <init>(Lj$/util/Spliterator;IZ)V
    ...
    invoke-direct {p0}, Lj$/util/stream/Node$-CC;-><init>()V
...
.method private sourceSpliterator(I)Lj$/util/Spliterator;
    ...
    :cond_0
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/AbstractPipeline;->opEvaluateParallelLazy(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;)Lj$/util/Spliterator;
...
.method final evaluate(Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    .line 2
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/AbstractPipeline;->evaluateToNode(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/Node$-CC;->makeNodeBuilder(JLj$/util/function/IntFunction;)Lj$/util/stream/Node$Builder;
...
.method final evaluate(Lj$/util/stream/TerminalOp;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/TerminalOp;->evaluateParallel(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/TerminalOp;->evaluateSequential(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method final evaluateToArrayNode(Lj$/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    invoke-virtual {p0, v0, v1, p1}, Lj$/util/stream/AbstractPipeline;->opEvaluateParallel(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/Node;
...
.method abstract evaluateToNode(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/Node;
.end method
...
.method abstract getOutputShape$enumunboxing$()I
.end method

.method final getSourceShape$enumunboxing$()I
    .locals 2
...
.method final synthetic lambda$spliterator$0$java-util-stream-AbstractPipeline()Lj$/util/Spliterator;
    .locals 1
...
.method opEvaluateParallel(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/Node;
    .locals 0
...
.method opEvaluateParallelLazy(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 1

    sget-object v0, Lj$/util/stream/Node$$ExternalSyntheticLambda0;->INSTANCE$1:Lj$/util/stream/Node$$ExternalSyntheticLambda0;

    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/AbstractPipeline;->opEvaluateParallel(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/Node;
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    invoke-direct {v1, p0, v2}, Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;-><init>(Ljava/lang/Object;I)V

    .line 1
    iget-boolean v0, v0, Lj$/util/stream/AbstractPipeline;->parallel:Z

    .line 2
    invoke-virtual {p0, p0, v1, v0}, Lj$/util/stream/AbstractPipeline;->wrap(Lj$/util/stream/Node$-CC;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method abstract wrap(Lj$/util/stream/Node$-CC;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
.end method
...
.method final wrapSpliterator(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-direct {v0, p1, v1}, Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;-><init>(Ljava/lang/Object;I)V
    ...
    .line 2
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/AbstractPipeline;->wrap(Lj$/util/stream/Node$-CC;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
