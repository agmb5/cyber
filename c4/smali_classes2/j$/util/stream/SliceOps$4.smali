...
.method constructor <init>(Lj$/util/stream/AbstractPipeline;IIJJ)V
    ...
    invoke-direct {p0, p1, p3}, Lj$/util/stream/DoublePipeline$StatefulOp;-><init>(Lj$/util/stream/AbstractPipeline;I)V
...
.method final opEvaluateParallel(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    invoke-static {v2, v0, v8}, Lj$/util/stream/Nodes;->collectDouble(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Z)Lj$/util/stream/Node$OfDouble;
    ...
    invoke-static {v9, v0, v8}, Lj$/util/stream/Nodes;->collectDouble(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Z)Lj$/util/stream/Node$OfDouble;
...
.method final opEvaluateParallelLazy(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    sget-object v4, Lj$/util/stream/SliceOps$4$$ExternalSyntheticLambda0;->INSTANCE:Lj$/util/stream/SliceOps$4$$ExternalSyntheticLambda0;
...
.method final unorderedSkipLimitSpliterator(Lj$/util/Spliterator$OfDouble;JJJ)Lj$/util/Spliterator$OfDouble;
    .locals 8
