...
.method constructor <init>(Lj$/util/stream/ForEachOps$ForEachTask;Lj$/util/Spliterator;)V
    ...
    iget-object p1, p1, Lj$/util/stream/ForEachOps$ForEachTask;->helper:Lj$/util/stream/Node$-CC;

    iput-object p1, p0, Lj$/util/stream/ForEachOps$ForEachTask;->helper:Lj$/util/stream/Node$-CC;

    return-void
.end method

.method constructor <init>(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Lj$/util/stream/Sink;)V
    .locals 1
...
.method public final compute()V
    ...
    iget-object v6, p0, Lj$/util/stream/ForEachOps$ForEachTask;->helper:Lj$/util/stream/Node$-CC;

    invoke-virtual {v6}, Lj$/util/stream/Node$-CC;->getStreamAndOpFlags()I
    ...
    :cond_4
    :goto_2
    iget-object v1, v8, Lj$/util/stream/ForEachOps$ForEachTask;->helper:Lj$/util/stream/Node$-CC;

    invoke-virtual {v1, v7, v0}, Lj$/util/stream/Node$-CC;->copyInto(Lj$/util/stream/Sink;Lj$/util/Spliterator;)V
