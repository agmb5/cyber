...
.field final ph:Lj$/util/stream/Node$-CC;

.field pusher:Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;
...
.method constructor <init>(Lj$/util/stream/Node$-CC;Lj$/util/Spliterator;Z)V
    ...
    iput-object p1, p0, Lj$/util/stream/StreamSpliterators$AbstractWrappingSpliterator;->ph:Lj$/util/stream/Node$-CC;
...
.method private fillBuffer()Z
    ...
    iget-object v0, p0, Lj$/util/stream/StreamSpliterators$AbstractWrappingSpliterator;->pusher:Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;

    iget v1, v0, Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;->$r8$classId:I
    ...
    .line 1
    :pswitch_0
    iget-object v0, v0, Lj$/util/stream/SpinedBuffer$$ExternalSyntheticLambda0;->f$0:Ljava/lang/Object;

    check-cast v0, Lj$/util/stream/StreamSpliterators$LongWrappingSpliterator;
    ...
    check-cast v0, Lj$/util/stream/StreamSpliterators$IntWrappingSpliterator;
    ...
    check-cast v0, Lj$/util/stream/StreamSpliterators$DoubleWrappingSpliterator;
    ...
    check-cast v0, Lj$/util/stream/StreamSpliterators$WrappingSpliterator;
...
.method public final characteristics()I
    ...
    invoke-virtual {v0}, Lj$/util/stream/Node$-CC;->getStreamAndOpFlags()I
...
.method public final getComparator()Ljava/util/Comparator;
    ...
    .line 1
    invoke-static {p0, v0}, Lj$/util/Map$-CC;->$default$hasCharacteristics(Lj$/util/Spliterator;I)Z
...
.method public final getExactSizeIfKnown()J
    ...
    invoke-virtual {v1}, Lj$/util/stream/Node$-CC;->getStreamAndOpFlags()I
